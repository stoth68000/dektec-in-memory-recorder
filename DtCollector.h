...
#define LTN_LIST_ITEMS 1024 /* Approx 4.8GB, 17 seconds */
...
struct app_context_s
{
        ...
        struct xorg_list listUsed;

        pthread_t threadId;
        int threadRunning, threadTerminate, threadComplete;
...
public:
    ...
    int  m_QamSymbolRate;       // -ms: Symbol rate for QAM-A/B/C
